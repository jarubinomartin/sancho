...
pro sancho_mfi_encoder_to_sky, jd, az_enc, el_enc, horn, coord1, coord2, parang, APPARENT=apparent, GALACTIC=galactic, $
...
if ((horn gt mfi.nhorn) or (horn lt 0)) then begin 
   print, ""
   print, " -- You must specify a horn number between 0 and "+strtrim(mfi.nhorn,2)+". Returning. "
   print, ""
   return
endif
x_horn = 0.d
...
if (horn ge 1) then begin 
   x_horn = -1.d0 * mfi.xpos[horn-1]/mfi.focal*r2d
   y_horn = mfi.ypos[horn-1]/mfi.focal*r2d
endif

;load pointing model, referred to center of focal plane 
print, ""
sancho_mfi_pmodel, pmodel, ihorn=horn, /center
print, ""
